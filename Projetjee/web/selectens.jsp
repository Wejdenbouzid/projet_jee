...
//connexion avec la base de données
                ...
                String sql = "SELECT * FROM `personne`,`enseignant` WHERE `IDPERS`=`IDENS` and `GRADE`!='NULL';";
        ...
        <tr>
			...
			<td><%= res.getString("GRADE")%> </td>
                        <td><%= res.getString("DEPARTEMENT")%> </td>
			
            <%String lien ="deletepers.jsp?id=" + id;%>
             <td><a href ="<%=lien%>">supprimer</a></td>  
            <%String lien1 ="updatens.jsp?id=" + id;%>
             <td><a href ="<%=lien1%>">Modifier</a></td> 
