...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px;">
  <div class="w3-display-middle" style="width:65%; margin-top:24%">
    ...
    <div id="Book" class="w3-container w3-white w3-padding-16 myLink">
      <h3>loan book</h3>
	  <p>Please enter your book to loan :</p>
      <div class="w3-row-padding" style="margin:0 -10px;">	  
	  <form method="POST" action="addloan.jsp"> 
            <table> <tr>
                    <td> <label>IDEMP:</label></td>
                    <td> <input class="w3-input w3-border" type="number" name="IDEMP" required /></td>
                </tr>
                <tr>
                    <td> <label>DATEMP:</label></td>
                    <td> <input class="w3-input w3-border" type="datetime-local" name="DATEMP" required /></td>
                </tr>
                <tr>
                    <td> <label>DATERETOUR:</label></td>
                    <td> <input class="w3-input w3-border" type="datetime-local" name="DATERETOUR" required /></td>
                </tr>
                <tr>
