...
String sql ="select * from `personne`,`etudiant` where `CLASSE`!='NULL' AND `IDPERS`='"+id+"' ";
...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px;">
  <div class="w3-display-middle" style="width:65%; margin-top:24%">
    <div class="w3-bar w3-black">
      <button class="w3-bar-item w3-button tablink" onclick="openLink(event, 'Book');"><i class="fa fa-book w3-margin-right"></i>Student</button>
    </div>
       <div id="Book" class="w3-container w3-white w3-padding-16 myLink">
        <h1>Update data from student </h1>
      <div class="w3-row-padding" style="margin:0 -10px;"></div>

<form method="post" action="update-process.jsp">
     <table> <tr>
<td> <label>id student : </label></td>
...
<tr>
    ...
    <td><input type="text" name="classroom" value="<%=res.getString("CLASSE") %>"></td>
</tr>
