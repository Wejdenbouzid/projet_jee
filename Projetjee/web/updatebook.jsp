...
String sql ="select * from `livre` where `ISBN`='"+id+"' ";
Statement stm = cx.createStatement();
ResultSet res = stm.executeQuery(sql);
while(res.next()){
    String idp = res.getString("ISBN");
%>
...
<body>
 <header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px;">
  <div class="w3-display-middle" style="width:65%; margin-top:24%">
    ...
    <h1>Update data from book </h1>
      <div class="w3-row-padding" style="margin:0 -10px;">   

<form method="post" action="update-process-book.jsp">
 <table> <tr>
          ...
          <tr>
                    ...
                    <td><input type="text" name="title" value="<%=res.getString("TITRE") %>"></td>
</tr>
                <tr>
                    <td> <label>Writer:</label></td>
                    <td><input type="text" name="author" value="<%=res.getString("AUTEURS") %>"></td>
                </tr>
